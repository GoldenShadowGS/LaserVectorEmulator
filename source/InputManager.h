...
public:
    ...
    bool KeyDown(int vk) const;     // held
    bool KeyPressed(int vk) const;  // went down this frame
    bool KeyReleased(int vk) const; // went up this frame
...
private:
    void PollHardware();            // GetAsyncKeyState for realtime
    struct ActionState
    {
        bool current = false;
        bool previous = false;
